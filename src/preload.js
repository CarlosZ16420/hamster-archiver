...
contextBridge.exposeInMainWorld('archiveApp', {
  ...
  repairIntegration: (adapterId, options = {}) => ipcRenderer.invoke('integrations:repair', adapterId, options),
  uninstallIntegration: (adapterId) => ipcRenderer.invoke('integrations:uninstall', adapterId),
  ...
  confirmTask: (jobId, options) => ipcRenderer.invoke('task:confirm', jobId, options),
  ...
  updateCatalogSourcePath: (recordId, sourcePath, sourceType) => ipcRenderer.invoke('catalog:update-source-path', recordId, sourcePath, sourceType),
  ...
  queueCatalogRecordsForRefresh: (recordIds) => ipcRenderer.invoke('catalog:queue-refresh', recordIds),
