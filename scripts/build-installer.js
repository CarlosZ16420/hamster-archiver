...
async function main() {
  ...
  run(process.execPath, [builderCli,
    ...
    '--config.executableName=HamsterArchiver',
    ...
    '--config.nsis.displayLanguageSelector=true',
    '--config.nsis.installerLanguages=en_US',
    '--config.nsis.installerLanguages=zh_CN',
    '--config.nsis.allowToChangeInstallationDirectory=false',
    '--config.nsis.include=scripts/installer-custom.nsh',
    '--config.nsis.installerIcon=assets/app-icon.ico',
    '--config.nsis.uninstallerIcon=assets/app-icon.ico',
    '--config.nsis.installerHeaderIcon=assets/app-icon.ico',
